...
// Your Channel Link
const char *channel_link = "https://t.me/VORT33X0008";

// Your Watermark (Base64 encoded of "This file is made by :- @PRIME_X_ARMY")
...
void show_banner() {
    ...
    printf("╚═╝     ╚═╝  ╚═╝╚═╝╚═╝     ╚═╝╚══════╝    ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝   ╚═╝   \n");
    printf("\n");
    printf("              ==== @PRIME_X_ARMY DDOS TOOL ====\n");
    printf("              ==== Channel: https://t.me/PrimeXArmy111 ====\n");
    printf("\n");
}
...
int main(int argc, char *argv[]) {
    ...
    printf("\n");
    printf("[+] =========================================\n");
    printf("[+] @PRIME_X_ARMY ATTACK STARTED!\n");
    ...
    printf("\n");
    printf("[+] =========================================\n");
    printf("[+] @PRIME_X_ARMY ATTACK COMPLETED!\n");
